...
function isActiveCheckbutton(layerName, type){
  ...
  if(GFI.activeCheckbuttons[layerName]!==undefined){
    if(GFI.activeCheckbuttons[layerName][type]!==undefined){
      return GFI.activeCheckbuttons[layerName][type]["active"];
    }
  }
  return false;
}
