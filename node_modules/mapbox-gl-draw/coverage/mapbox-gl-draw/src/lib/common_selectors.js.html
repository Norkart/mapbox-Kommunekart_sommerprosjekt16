...
<html lang="en">
<head>
    <title>Code coverage report for mapbox-gl-draw/src/lib/common_selectors.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">mapbox-gl-draw/src/lib/</a> common_selectors.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">module.exports = {
  isOfMetaType: function(type) {
    return function(e) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!featureTarget.properties) <span class="cstat-no" title="statement not covered" >return false;</span>
